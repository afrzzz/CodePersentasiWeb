...
const Slide11 = () => {const fullText = "Fitur: Keranjang & Checkout";
      ...
      return (
        ...
        <ul className="text-left list-disc list-inside text-base md:text-lg text-gray-100 space-y-2">
          <li>
            <span className="text-cyan-300 font-semibold">Keranjang Dinamis:</span> Pengguna dapat menambahkan atau menghapus produk sebelum membeli.
          </li>
          <li>
            <span className="text-cyan-300 font-semibold">Checkout & Konfirmasi:</span> Proses pemesanan dilakukan dengan form konfirmasi pesanan.
          </li>
          <li>
            <span className="text-cyan-300 font-semibold">Riwayat Pesanan:</span> Pengguna dapat melihat pesanan yang telah dilakukan secara lengkap.
          </li>
        </ul>
      </motion.div>
    </div>
