...
const Slide4 = () => {
  const fullText = "Tujuan Penelitian";
    ...
    return (
      <div className="min-h-screen w-full bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] flex items-center justify-center px-4 md:px-12 text-white">
        ...
        <ol className="text-base md:text-lg leading-relaxed text-gray-200 list-disc list-inside space-y-3">
          <li>Menyediakan informasi produk yang lengkap dan memudahkan proses pemesanan bagi pelanggan.</li>
          <li>Meningkatkan kemudahan akses bagi pelanggan melalui website yang responsif.</li>
        </ol>
      </motion.div>
    </div>
  );
