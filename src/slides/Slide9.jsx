...
const Slide9 = () => {
  const fullText = "Fitur: Autentikasi Pengguna";
        ...
        <ul className="text-left list-disc list-inside text-base md:text-lg text-gray-100 space-y-2">
          <li>
            <span className="text-cyan-300 font-semibold">Registrasi & Login:</span> Pengguna dapat membuat akun dan masuk ke sistem.
          </li>
          <li>
            <span className="text-cyan-300 font-semibold">Validasi Keamanan:</span> Proteksi input dari kesalahan dan potensi serangan.
          </li>
          <li>
            <span className="text-cyan-300 font-semibold">Manajemen Sesi:</span> Login aman dan logout otomatis jika idle.
          </li>
        </ul>
      </motion.div>
    </div>
