...
const Slide10 = () => {
  const fullText = "Fitur: Manajemen Produk";
        ...
        <ul className="text-left list-disc list-inside text-base md:text-lg text-gray-100 space-y-2">
          <li>
            <span className="text-cyan-300 font-semibold">Daftar Produk:</span> Menampilkan produk lengkap dengan nama, harga, deskripsi, dan gambar.
          </li>
          <li>
            <span className="text-cyan-300 font-semibold">Pencarian & Filter:</span> Memudahkan pengguna dalam mencari produk berdasarkan kategori atau kata kunci.
          </li>
          <li>
            <span className="text-cyan-300 font-semibold">Halaman Detail:</span> Menampilkan informasi produk secara lengkap sebelum pembelian.
          </li>
        </ul>
      </motion.div>
    </div>
